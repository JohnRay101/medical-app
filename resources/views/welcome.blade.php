...
<head>
    ...
    <title> Healthcare Appointment System | Norie | Julie | Rhea </title>

    <link rel="shortcut icon" href="assets/assets/images/fav.jpg">
    <link rel="stylesheet" href="assets/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/assets/css/fontawsom-all.min.css">
    <link rel="stylesheet" href="assets/assets/plugins/slider/css/owl.carousel.min.css">
    <link rel="stylesheet" href="assets/assets/plugins/slider/css/owl.theme.default.css">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3 no-padding col-sm-12 nav-img">
                        <img src="assets/assets/images/logo.jpg" alt="">
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a href="{{route('login')}}"><button class="btn btn-success">Book an Appointment</button></a>
                    </div>
                </div>
   ...
   <div  class="slider container-fluid">
        <ul id="slider">
            <li data-active="1" data-background="assets/assets/images/slider/slider_1.jpg">
                <div class="slider-layer">
                    <div class="container">
                        <h1 class="animated  fadeInRightBig ">Healthcare Appointment System | Norie | Julie | Rhea</h1>
            ...
            <li data-active="0" data-background="assets/assets/images/slider/slider_1.jpg">
                <div class="slider-layer">
                    <div class="container">
        ...
        <div class="container">
            <div class="row">
               <div class="col-lg-6 col-md-12">
                    <img src="assets/assets/images/why.jpg" alt="">
                </div>
...
But you can read the following facts in order to make sure of all pluses of our clinic:</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="blog-singe no-margin row">
                                <div class="col-sm-5 blog-img-tab">
                                    <img src="assets/assets/images/blog/blog_01.jpg" alt="">
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="blog-singe no-margin row">
                                <div class="col-sm-5 blog-img-tab">
                                    <img src="assets/assets/images/blog/blog_02.jpg" alt="">
                                </div>
                                <div class="col-sm-7 blog-content-tab">
                                    <h2>Why Primary treatment is important ?</h2>
                                    <p><i class="fas fa-user"><small>Admin</small></i>  <i class="fas fa-eye"><small>(12)</small></i>  <i class="fas fa-comments"><small>(12)</small></i></p>
        ...
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/assets/images/gallery/gallery_01.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="assets/assets/images/gallery/gallery_02.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/assets/images/gallery/gallery_03.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                <img src="assets/assets/images/gallery/gallery_04.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/assets/images/gallery/gallery_05.jpg" class="img-responsive">
            </div>

          

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/assets/images/gallery/gallery_06.jpg" class="img-responsive">
            </div>
            ...
            <div class="row team-row">
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/assets/images/team/team-memb1.jpg" alt="">
                        <div class="det-o">
                            <h4>David Kanuel</h4>
                            <i>Facial Surgan</i>
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/assets/images/team/team-memb2.jpg" alt="">
                        <div class="det-o">
                            <h4>David Kanuel</h4>
                            <i>Facial Surgan</i>
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/assets/images/team/team-memb3.jpg" alt="">
                        <div class="det-o">
                            <h4>David Kanuel</h4>
                            <i>Facial Surgan</i>
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/assets/images/team/team-memb4.jpg" alt="">
                        <div class="det-o">
                            <h4>David Kanuel</h4>
                            <i>Facial Surgan</i>
                        </div>
...
<script src="assets/assets/plugins/scroll-fixed/jquery-scrolltofixed-min.js"></script>
<script src="assets/assets/plugins/scroll-nav/js/jquery.easing.min.js"></script>    
<script src="assets/assets/plugins/scroll-nav/js/scrolling-nav.js"></script>
